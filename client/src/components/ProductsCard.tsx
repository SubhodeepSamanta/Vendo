    ...
    <div className='shadow-lg rounded-lg overflow-hidden mt-4'>
      <div className='relative aspect-[2/3]'>
        ...
        <div className='flex items-center justify-start pl-4 gap-6 mb-4'>
          <p className='flex flex-col text-gray-700 gap-1'>
            Size
          ...
          <p className='flex flex-col gap-2 text-gray-500 px-2 py-1'>
            Colors
        ...
        <div className='flex items-center justify-between m-4'>
          ...
          <div className='ring ring-gray-300 flex gap-2 text-sm items-center px-2 py-1 rounded-md shadow-xl cursor-pointer hover:bg-gray-800 hover:text-white transition-all duration-200'>
            <ShoppingCart/>
            Add to Cart
          </div>
        </div>
